...
class ManageContentForm(forms.Form):
    ...
    owner = UserModelChoiceField(User.objects.filter(Q(userprofile__role=mgmnt_models.UserProfile.ROLE_SENDER) |
                                                       Q(userprofile__role=mgmnt_models.UserProfile.ROLE_ADMIN)).
