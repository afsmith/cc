...
class SerializersTest(ClientTestCase):
    ...
    def test_links_to_scorm_files_for_users_specify_real_segment_id(self):
        ...
        user = CUser()
        user.save()
        profile = mgmnt_models.UserProfile(user=user, role=mgmnt_models.UserProfile.ROLE_RECIPIENT)
        profile.save()
    ...
    def test_links_to_scorm_files_for_admins_specify_preview_segment_id(self):
        ...
        user = CUser()
        user.save()
        profile = mgmnt_models.UserProfile(user=user, role=mgmnt_models.UserProfile.ROLE_SENDER)
        profile.save()
