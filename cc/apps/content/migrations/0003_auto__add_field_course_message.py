...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.message'
        db.add_column(u'content_course', 'message',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cc_messages.Message']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.message'
        db.delete_column(u'content_course', 'message_id')
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'3vOfW9aIaRBbFARlrXVzMm'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'2cgu4'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'SCkOX'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'joHNp'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'O3NUo'", 'max_length': '5'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
