...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.index'
        db.add_column(u'content_file', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.index'
        db.delete_column(u'content_file', 'index')
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'l4eg4iP1kPKhaGra7SjfN9'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'L0YNM'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'z7FJW'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'8WLdS'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'UYIcj'", 'max_length': '5'}),
