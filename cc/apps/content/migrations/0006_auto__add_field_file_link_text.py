...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'File.link_text'
        db.add_column(u'content_file', 'link_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'File.link_text'
        db.delete_column(u'content_file', 'link_text')
    ...
    models = {
        ...
        u'content.file': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ZobTMMaQKydtVyUvDinDSR'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'rZTT5'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'RWnJu'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'QVE9P'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'1y2db'", 'max_length': '5'}),
