...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.crmContactId'
        db.add_column(u'address_book_contact', 'crmContactId',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.crmContactId'
        db.delete_column(u'address_book_contact', 'crmContactId')
