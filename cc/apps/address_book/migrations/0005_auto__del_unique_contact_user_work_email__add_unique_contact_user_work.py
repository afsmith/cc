...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Contact', fields ['user', 'work_email']
        db.delete_unique(u'address_book_contact', ['user_id', 'work_email'])

        # Adding unique constraint on 'Contact', fields ['user', 'work_email', 'crmContactId']
        db.create_unique(u'address_book_contact', ['user_id', 'work_email', 'crmContactId'])


    def backwards(self, orm):
        # Removing unique constraint on 'Contact', fields ['user', 'work_email', 'crmContactId']
        db.delete_unique(u'address_book_contact', ['user_id', 'work_email', 'crmContactId'])

        # Adding unique constraint on 'Contact', fields ['user', 'work_email']
        db.create_unique(u'address_book_contact', ['user_id', 'work_email'])
    ...
    models = {
        ...
        u'address_book.contact': {
            'Meta': {'unique_together': "(('user', 'work_email', 'crmContactId'),)", 'object_name': 'Contact'},
            'company': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'crmContactId': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
