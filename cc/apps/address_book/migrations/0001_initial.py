...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'address_book_contact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('work_email', self.gf('django.db.models.fields.EmailField')(max_length=100)),
            ('work_phone', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('work_fax', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('work_website', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('personal_email', self.gf('django.db.models.fields.EmailField')(max_length=100, blank=True)),
        ...
        db.send_create_signal(u'address_book', ['Contact'])


    def backwards(self, orm):
        # Deleting model 'Contact'
        db.delete_table(u'address_book_contact')
