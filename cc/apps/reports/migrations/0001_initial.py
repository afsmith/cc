...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bounce'
        db.create_table(u'reports_bounce', (
            ...
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CUser'], null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'reports', ['Bounce'])


    def backwards(self, orm):
        # Deleting model 'Bounce'
        db.delete_table(u'reports_bounce')
    ...
    models = {
        ...
        u'reports.bounce': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.CUser']", 'null': 'True', 'blank': 'True'}),
