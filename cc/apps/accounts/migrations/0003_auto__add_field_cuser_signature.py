...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CUser.signature'
        db.add_column(u'accounts_cuser', 'signature',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CUser.signature'
        db.delete_column(u'accounts_cuser', 'signature')
    ...
    models = {
        ...
        u'accounts.oneclicklinktoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'dvBBgSAhYMnscXdO4BVHiBbVDrBCDO'", 'max_length': '30'}),
