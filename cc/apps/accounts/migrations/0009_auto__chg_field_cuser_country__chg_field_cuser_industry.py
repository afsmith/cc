...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CUser.country'
        db.alter_column(u'accounts_cuser', 'country', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CUser.industry'
        db.alter_column(u'accounts_cuser', 'industry', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'CUser.country'
        db.alter_column(u'accounts_cuser', 'country', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 5, 7, 0, 0), max_length=50))

        # Changing field 'CUser.industry'
        db.alter_column(u'accounts_cuser', 'industry', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 5, 7, 0, 0), max_length=50))
    ...
    models = {
        ...
        u'accounts.invitation': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'hfhODNaO1h4wzp4XATnUCYwLj6tkL5'", 'max_length': '30'}),
        ...
        u'accounts.oneclicklinktoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'rzWoM3PLKFTH3EArW3ZAejttlXyC84'", 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.CUser']"})
        },
        u'auth.group': {
