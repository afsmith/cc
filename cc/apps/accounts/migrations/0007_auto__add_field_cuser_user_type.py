...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CUser.user_type'
        db.add_column(u'accounts_cuser', 'user_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CUser.user_type'
        db.delete_column(u'accounts_cuser', 'user_type')
    ...
    models = {
        ...
        u'accounts.invitation': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'xiNOVI2O0BDEagxLpdj2UcmefgbTJh'", 'max_length': '30'}),
        ...
        u'accounts.oneclicklinktoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'WVkxg7gs2tc1UjCJfm6YW9RUwAZoXp'", 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.CUser']"})
        },
        u'auth.group': {
