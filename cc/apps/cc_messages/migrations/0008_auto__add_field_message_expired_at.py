...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.expired_at'
        db.add_column(u'cc_messages_message', 'expired_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.expired_at'
        db.delete_column(u'cc_messages_message', 'expired_at')
    ...
    models = {
        ...
        u'content.file': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'Qpbm65GKk8SCrdZeTKijeo'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'8POoa'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'0nnsY'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'3Liza'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'h0fLA'", 'max_length': '5'}),
