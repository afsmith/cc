...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'cc_messages_message', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owner', null=True, to=orm['accounts.CUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.owner'
        db.delete_column(u'cc_messages_message', 'owner_id')
