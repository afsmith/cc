...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.notify_email_opened'
        db.delete_column(u'cc_messages_message', 'notify_email_opened')

        # Deleting field 'Message.notify_link_clicked'
        db.delete_column(u'cc_messages_message', 'notify_link_clicked')


    def backwards(self, orm):
        # Adding field 'Message.notify_email_opened'
        db.add_column(u'cc_messages_message', 'notify_email_opened',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Message.notify_link_clicked'
        db.add_column(u'cc_messages_message', 'notify_link_clicked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'3gFqshLXCqAfI5QUQjIOWm'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'MaGNi'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'6RN1N'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'iz2SK'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'M086l'", 'max_length': '5'}),
