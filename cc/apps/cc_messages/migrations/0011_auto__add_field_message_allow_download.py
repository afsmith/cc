...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.allow_download'
        db.add_column(u'cc_messages_message', 'allow_download',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.allow_download'
        db.delete_column(u'cc_messages_message', 'allow_download')
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'Tx1prRH2x56kk1vhOa54uu'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'gl2bU'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'KSNmW'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'yRVZ3'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'EzdRX'", 'max_length': '5'}),
