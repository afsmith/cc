...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.pricing_page'
        db.delete_column(u'cc_messages_message', 'pricing_page')
    ...
    def backwards(self, orm):
        # Adding field 'Message.pricing_page'
        db.add_column(u'cc_messages_message', 'pricing_page',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'4iZopRafaVWgHW0DziO72x'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'p4TcH'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'WILh6'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'UPkwR'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'hnZHl'", 'max_length': '5'}),
