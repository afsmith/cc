...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tracking_trackinglog', (
        ...
        db.send_create_signal(u'tracking', ['TrackingLog'])


    def backwards(self, orm):
        # Deleting model 'TrackingLog'
        db.delete_table(u'tracking_trackinglog')
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'9m6lzytyVQ1ur9ZIgW6yJN'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'wdixb'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'YncNd'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'Cf21x'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'9pGVh'", 'max_length': '5'}),
