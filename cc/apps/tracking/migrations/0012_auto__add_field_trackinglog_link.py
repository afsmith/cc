...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackingLog.link'
        db.add_column(u'tracking_trackinglog', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cc_messages.Link'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackingLog.link'
        db.delete_column(u'tracking_trackinglog', 'link_id')
    ...
    models = {
        ...
        u'cc_messages.link': {
            ...
            'converted_key': ('django.db.models.fields.CharField', [], {'default': "'4wKYNBck0XSLdcgAK3WUWQ'", 'unique': 'True', 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'Csn7aQ7wdc968PBQAB0760'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'y6EKW'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'CaRxv'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'ysZ5c'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'vPNze'", 'max_length': '5'}),
        ...
        u'tracking.trackinglog': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cc_messages.Link']", 'null': 'True'}),
