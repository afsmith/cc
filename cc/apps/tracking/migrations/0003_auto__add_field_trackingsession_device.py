...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackingSession.device'
        db.add_column(u'tracking_trackingsession', 'device',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackingSession.device'
        db.delete_column(u'tracking_trackingsession', 'device')
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'znmAH6ezPXuNVwl0sSTS34'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'EIHdZ'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'NtKzG'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'LBh2U'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'VRe0w'", 'max_length': '5'}),
