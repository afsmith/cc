...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackingEvent.page_view'
        db.add_column(u'tracking_trackingevent', 'page_view',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackingEvent.page_view'
        db.delete_column(u'tracking_trackingevent', 'page_view')
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'cT7BVML3RoZqg7V3dAwdwz'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'5YT4y'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'hbH2X'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'V9PGr'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'kh4Uv'", 'max_length': '5'}),
