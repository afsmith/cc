...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackingLog.client_ip'
        db.add_column(u'tracking_trackinglog', 'client_ip',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'TrackingLog.device'
        db.add_column(u'tracking_trackinglog', 'device',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'TrackingLog.location'
        db.add_column(u'tracking_trackinglog', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackingLog.client_ip'
        db.delete_column(u'tracking_trackinglog', 'client_ip')

        # Deleting field 'TrackingLog.device'
        db.delete_column(u'tracking_trackinglog', 'device')

        # Deleting field 'TrackingLog.location'
        db.delete_column(u'tracking_trackinglog', 'location')
    ...
    models = {
        ...
        u'content.file': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'default': "'S5UDmDWPJv7mTbFBCI4AeQ'", 'unique': 'True', 'max_length': '22'}),
            ...
            'subkey_conv': ('django.db.models.fields.CharField', [], {'default': "'CW6Id'", 'max_length': '5'}),
            'subkey_orig': ('django.db.models.fields.CharField', [], {'default': "'m8lf5'", 'max_length': '5'}),
            'subkey_preview': ('django.db.models.fields.CharField', [], {'default': "'Ei2ra'", 'max_length': '5'}),
            'subkey_thumbnail': ('django.db.models.fields.CharField', [], {'default': "'7tcAs'", 'max_length': '5'}),
